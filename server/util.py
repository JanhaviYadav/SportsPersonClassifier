...
if __name__ == '__main__':
    ...
    # Inconsistent
    # result could be due to https://github.com/scikit-learn/scikit-learn/issues/13211 print(classify_image(None, 
    # "./test_images/serena1.jpg")) print(classify_image(None, "./test_images/serena2.jpg")) print(classify_image(
